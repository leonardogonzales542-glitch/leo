...
<aside class="flex-shrink-0 bg-white border-end d-flex flex-column position-sticky top-0 vh-100" style="width: 250px; min-width: 250px;">
    <!-- Brand Logo Section -->
    <div class="d-flex flex-column align-items-center justify-content-center pt-5 pb-3">
        <i class="fa-solid fa-leaf brand-icon fs-1 mb-2"></i>
        <h4 class="fw-bold text-dark m-0" style="font-family: var(--font-heading); font-weight: 800;">Mi Negocio</h4>
        <small class="brand-subtitle fw-bold mt-1" style="font-size: 0.75rem;">Admin Panel</small>
    </div>
...
<main class="flex-grow-1 d-flex flex-column min-vh-100" style="background-color: #fafafa; min-width: 0;">
    <!-- Top Header -->
    <header class="d-flex align-items-center justify-content-end px-4 py-3 bg-white border-bottom position-sticky top-0" style="z-index: 1020;">
        <div class="d-flex align-items-center gap-4">
            <!-- Color Home Toggle Fake -->
            <div class="d-flex align-items-center gap-2 border rounded-pill px-3 py-1 bg-light text-muted" style="cursor: pointer;">
                <i class="fa-solid fa-palette" style="font-size: 0.8rem;"></i>
                <span style="font-size: 0.75rem; font-weight: 700; letter-spacing: 0.5px;">COLOR HOME: #FFFFFF</span>
                <span class="rounded-circle border bg-white shadow-sm" style="width: 14px; height: 14px; margin-left: 5px;"></span>
            </div>
            
            <!-- User Profile Dropdown -->
            <div class="d-flex align-items-center gap-3 border rounded-pill px-3 py-1" style="cursor: pointer;">
                <span class="fw-bold text-dark" style="font-size: 0.85rem;"><?= htmlspecialchars($rol_nombre) ?></span>
                <div class="rounded-circle bg-light border d-flex align-items-center justify-content-center text-dark fw-bold shadow-sm" style="width: 26px; height: 26px; font-size: 12px;">
